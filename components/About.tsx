    ...
    <section className="w-full h-full flex flex-col justify-center px-4 sm:px-8 py-4 relative">
      <div className="max-w-lg mx-auto w-full relative z-10">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="text-blue-700 dark:text-blue-400 font-semibold text-xl block mb-3">
  ...
  return (
    <section className="w-full h-full flex flex-col justify-center px-4 sm:px-8 py-4 relative">
      <div className="max-w-lg mx-auto w-full relative z-10 space-y-4 md:space-y-6">
        ...
        >
          <h3 className="text-xl font-bold text-blue-700 dark:text-blue-400 mb-3 text-center font-serif">
        ...
        <motion.div
          ...
          className="p-4 md:p-5 bg-blue-50/50 dark:bg-blue-950/30 rounded-xl border border-blue-200/50 dark:border-blue-800/50"
        >
          <h3 className="text-lg font-bold text-blue-700 dark:text-blue-400 mb-2 text-center font-serif">Mon parcours personnel</h3>
