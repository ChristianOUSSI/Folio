    ...
    <section className="w-full h-full flex flex-col justify-center px-4 sm:px-8 py-0 sm:py-4 relative">
      <div className="max-w-lg mx-auto w-full relative z-10">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="text-slate-900 dark:text-slate-100 font-semibold text-xl block mb-3">
            ...
            d'Informations à l'Université The Brains, je suis <span className="text-slate-900 dark:text-slate-100 font-semibold">motivé</span>, <span className="text-slate-800 dark:text-slate-200 font-semibold">créatif</span>,
            <span className="text-slate-900 dark:text-slate-100 font-semibold"> innovant</span>, passionné par la technologie et <span className="text-slate-800 dark:text-slate-200 font-semibold">dynamique</span>. 
  ...
  return (
    <section className="w-full h-full flex flex-col justify-center px-4 sm:px-8 py-0 sm:py-4 relative">
      <div className="max-w-lg mx-auto w-full relative z-10 space-y-4 md:space-y-6">
        ...
        >
          <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 text-center font-serif">
        ...
        >
          <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 text-center font-serif">Mon parcours personnel</h3>
